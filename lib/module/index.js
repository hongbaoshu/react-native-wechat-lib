...
const {
  WeChat
} = NativeModules; // Event emitter to dispatch request and response from WeChat.
...
export const openWXApp = wrapApi(WeChat.openWXApp); // wrap the APIs
...
export function launchMiniProgram(_ref) {
  let {
    userName,
    miniProgramType = 0,
    path = ''
